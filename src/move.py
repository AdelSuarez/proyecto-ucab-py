class Move:
    ...
    def advance(self):
        ...
        Move._movement_made: bool = False
            ...
            for index_column, column in enumerate(row):
                ...
                if column == '>' and self.address == 'E':
                    ...
                    if index_column-1 == -1:
                        ...
                        self.__movement_to_the_left(row, index_column, '#')
                        break
                    ...
                    self.__collision(0, row, index_column, '^')
                    ...
                    if self.map_game[index_row-1][index_column] == '*':
                        ...
                        self.__upward_movement(
                            row, index_column, index_row,  '#')
                        break
                    ...
                    self.__collision(-1, row, index_column, 'v')
    ...
    def __collision(self, fila, row, index_column, robot):
    ...
    def __movement_to_the_right(self, row, index_column, asset):
        row[index_column] = ' '
        row[index_column+1] = asset
        Move._movement_made = True

    def __movement_to_the_left(self, row, index_column, asset):
        row[index_column] = ' '
        row[index_column-1] = asset
        Move._movement_made = True

    def __upward_movement(self, row, index_column, index_row,  asset):
        row[index_column] = ' '
        self.map_game[index_row-1][index_column] = asset
        Move._movement_made = True

    def __movement_down(self, row, index_column, index_row,  asset):
        row[index_column] = ' '
        self.map_game[index_row+1][index_column] = asset
        Move._movement_made = True
