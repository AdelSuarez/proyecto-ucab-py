...
# class Main_screen:
#     def __init__(self):
#         self._map_game = Create_map(16,27)
#         print(self._map_game)
#         self._robot= pygame.transform.scale(pygame.image.load("src/screen/assets/robot.png"), (40, 40))
#         self._bomb= pygame.transform.scale(pygame.image.load("src/screen/assets/bomba.png"), (35, 35))
#         self._goal= pygame.transform.scale(pygame.image.load("src/screen/assets/meta.png"), (35, 35))
#         self.settings()
#         self.wiget_main()
...
#                 if self._map_game[fila][columna] == '1':
